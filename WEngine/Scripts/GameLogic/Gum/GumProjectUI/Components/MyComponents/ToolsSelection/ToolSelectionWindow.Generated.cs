...
partial class ToolSelectionWindow : EditorWindow
{
    ...
    public Panel ToolsPanel { get; protected set; }
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        ToolsPanel = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.TryGetFrameworkElementByName<Panel>(this.Visual,"ToolsPanel");
        CustomInitialize();
    }
